                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2">
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-md-7">
                                        <label for="" class="form-label">Level: <span style="color: green">{{App\Models\Level::getLevel($enrollment->level_id)->level}}</span></label>
                                        <div class="col form-group" id="info">
                                            <label for="level" class="form-label"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="col form-group mt-2" id="info">
                                            @foreach(json_decode($enrollment->requirement_images) as $requiredFileImg)
                                                <img alt="Requirement Image" class="p-1 requirementImages" src='{{asset("requiredFileImgs/$requiredFileImg")}}' style="width: 100px; height:120px;"/>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="col form-group mt-2" id="info">
                                            <img src='{{asset("requiredFileImgs/$enrollment->payment_image")}}' alt="" style="width: 100px; height:120px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
