...
<div class="card" id="user-card">
    ...
    <div class="card-header" id="user-card-header">
        <a class="btn btn-outline-primary mb-2 float-end" href=""><i class='bx bx-arrow-back'></i> Back</a>
    </div>
    ...
    <div class="card-body" id="user-card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2">
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="" class="form-label"><strong> Student Name:</strong> <span style="color: green">Cyreen Cabahug</span></label>
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <label for="" class="form-label">Strand: <span style="color: green">STEM </span></label>
                                        <div class="col form-group" id="info">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2">
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-md-7">
                                        <label for="" class="form-label">Title: <span style="color: green">ASDASDAD</span></label>
                                        <div class="col form-group" id="info">
                                            <label for="level" class="form-label"></label>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <label for="" class="form-label">Remarks: <span style="color: green">ASDASDASD</span></label>
                                        <div class="col form-group" id="info">
                                            <label for="student_type" class="form-label"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="col form-group mt-2" id="info">
                                            {{-- @foreach(json_decode($enrollment->requirement_images) as $requiredFileImg)
                                                <img alt="Requirement Image" class="p-1 requirementImages" src='' style="width: 100px; height:120px;"/>
                                            @endforeach --}}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <label for="" class="form-label">Amount Paid: <span style="color: green">1,000</span></label>
                                        <div class="col form-group" id="info">
                                            <label for="student_type" class="form-label"></label>
                                        </div>
                                    </div>
        ...
        <div class="form-group justify-content-between"> 
            <div class="col-md-2 float-end mt-1">
                <button class="btn btn-primary form-control"><i class="fas fa-check"></i> Approve</button> 
            </div>   
